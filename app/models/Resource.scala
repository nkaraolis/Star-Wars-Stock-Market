...
class LightsaberCrystal extends Resource(resourceID = 6, name ="Lightsaber Crystal")
...
class RepublicCredit extends Resource(resourceID = 11, name ="Republic Credit", resourceType = "currencies")
...
class NovaCrystal extends Resource(resourceID = 14, name ="Nova Crystal", resourceType = "currencies")